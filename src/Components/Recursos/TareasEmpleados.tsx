  ...
  return (
    <div>
      <div className={`${versionSoporteStyle.card2}`}>
              <div className={versionSoporteStyle.contentDescriptionRecursos}>
                  ...
                  <div className={versionSoporteStyle.contentIconRecursos}
                       onClick={() => modifyHour(fecha)}>{ <FaEdit /> }
                  </div>
                  <div className={versionSoporteStyle.contentIconRecursos}
                       onClick={() => deleteHour(fecha)}>{ <FaTrash /> }
                  </div>
              </div>
      </div>
